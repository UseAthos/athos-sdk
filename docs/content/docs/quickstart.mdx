...
<Callout type="warn">
  ...
  `BROWSER_NOT_SUPPORTED` on anything else — including Safari, mobile, and server-side rendering — so
  call it on the client and check first. See [Browser support](/sdk/browser-support).
</Callout>
