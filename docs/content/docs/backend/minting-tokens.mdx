...
the next calendar month, or when your Athos contact raises it. Surface it to the rep as "practice is
unavailable this month". Full envelope and list: [error reference](/reference/errors).
